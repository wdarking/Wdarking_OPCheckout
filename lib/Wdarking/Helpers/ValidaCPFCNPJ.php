<?php
/**
 * Wdarking_Helpers_ValidaCPFCNPJ valida e formata CPF e CNPJ
 *
 * Exemplo de uso:
 * $cpf_cnpj  = new Wdarking_Helpers_ValidaCPFCNPJ('71569042000196');
 ...
 */
class Wdarking_Helpers_ValidaCPFCNPJ
{
    /**
